...
const NavItem = ({ svg, text, link }) => {
  return (
    <a className="sidebar-nav-item">
      <span className="sidebar-nav-item-icon">{svg}</span>
      <span className="sidebar-nav-item-link" href={`#${link}`}>
        {text}
      </span>
    </a>
  )
  ...
  return (
    <div className="sidebar-nav-container">
      <div className="sidebar-nav-group">
        <div className="sidebar-nav-group-title">Main</div>
        <NavItem
          link="unknown"
          svg={
            <svg
      ...
      <div className="sidebar-nav-group">
        <div className="sidebar-nav-group-title">Payments</div>
        ...
        <NavItem
          ...
          svg={
            ...
            >
              <path
                d="M19.3214 10.5V5.07145H15.25H6.42857H3.03571C1.91132 5.07145 1 4.16013 1 3.03574V17.2857C1 18.7847 2.21532 20 3.71429 20H19.3214V14.5714"
                stroke="#7F8FA4"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
              <path
                d="M21.3572 14.5714H16.6072C15.4828 14.5714 14.5715 13.6601 14.5715 12.5357C14.5715 11.4113 15.4828 10.5 16.6072 10.5H21.3572V14.5714Z"
                stroke="#7F8FA4"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
              <path
                d="M15.25 2.35714V1H3.03571C1.91132 1 1 1.91132 1 3.03571C1 4.16011 1.91132 5.07143 3.03571 5.07143"
                stroke="#7F8FA4"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
        ...
        <NavItem
          ...
          svg={
            ...
            >
              ...
              <path
                d="M9.75 15.225L11.4 16.875L15.25 14.125"
                stroke="#647787"
              />
              <path
      ...
      <div className="sidebar-nav-group">
        <div className="sidebar-nav-group-title">Orders</div>
